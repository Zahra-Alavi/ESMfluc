...
COMMANDS = {
    ...
    "phase3b-safeguards": "analyze_phase3b_structural_safeguards",
    "apex-structure": "analyze_signed_band_apex_structure",
    "band-interval-structure": "analyze_signed_band_interval_structure",
