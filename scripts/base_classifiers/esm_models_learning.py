...
class ESMModelLearning:
    ...
    def run(self):
        ...
        # "esm1_t6_43M_UR50S", "esm1_t12_85M_UR50S", "esm1_t34_670M_UR100", "esm1_t34_670M_UR50D", "esm1_t34_670M_UR50S", "esm1b_t33_650M_UR50S", "esm_msa1_t12_100M_UR50S", "esm_msa1b_t12_100M_UR50S", "esm1v_t33_650M_UR90S_[1-5]", "esm_if1_gvp4_t16_142M_UR50", "esmfold_v0", "esmfold_v1",
        ...
        with open("../../results/esm_model_results.txt", "w") as f:
            ...
            f.write(tabulate([], headers=["Model", "Accuracy", "Macro F1", "Weighted F1"], tablefmt="github"))
        for model in esm_models:
            ...
            with open("../../results/esm_model_results.txt", "a") as f:
                f.write("\n")   
                f.write(tabulate([results[-1]], tablefmt="github"))
