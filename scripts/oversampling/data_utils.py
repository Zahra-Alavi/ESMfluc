...
def compute_sampling_weights(dataset, num_classes, neq_thresholds, oversampling_threshold=0.10, undersampling_threshold=0.01, oversampling_intensity = 5.0, undersampling_intensity = 0.1):
    """
